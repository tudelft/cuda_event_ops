...
class Iterative3DWarpCuda(torch.autograd.Function):
    ...
    @staticmethod
    def forward(ctx, points, flow_fields, num_warps, threads, points_per_thread):
        warped_points = iterative_3d_warp_forward(points, flow_fields, num_warps, threads, points_per_thread)
    ...
    def backward(ctx, grad_output):
        ...
        return grad_points, grad_flow_fields, None, None, None


def iterative_3d_warp_cuda(points, flow_fields, num_warps, threads=1024, points_per_thread=1):
    return Iterative3DWarpCuda.apply(points, flow_fields, num_warps, threads, points_per_thread)
