...
def iterative_3d_warp_torch(events, flows, base, keep_warping, num_backprop_points, mode="bilinear"):
    """
...
if __name__ == "__main__":
    ...
    for name, functions in methods.items():
        ...
        warped_events = warp_fn(events, flows, d, True, 0)  # no mode trilinear yet for cuda
